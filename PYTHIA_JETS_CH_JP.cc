...
namespace Rivet
{
  class PYTHIA_JETS_CH_JP : public Analysis
  {
  public:
    RIVET_DEFAULT_ANALYSIS_CTOR(PYTHIA_JETS_CH_JP);
    ...
    void init()
    {
	 ...
	 abort();
      ...
      mytxtfile.open("pythia_20_pthat_20_pt_jets_ch_jp_matched.txt");
      mytxtfile_long.open("pythia_20_pthat_20_pt_jets_ch_jp.txt");
  ...
  RIVET_DECLARE_PLUGIN(PYTHIA_JETS_CH_JP);
}
