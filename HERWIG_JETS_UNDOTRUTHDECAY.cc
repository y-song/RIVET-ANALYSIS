...
namespace Rivet
{
  class HERWIG_JETS_UNDOTRUTHDECAY : public Analysis
  {
  public:
    RIVET_DEFAULT_ANALYSIS_CTOR(HERWIG_JETS_UNDOTRUTHDECAY);
    ...
    void init()
    {
      ...
      // open output file
      mytxtfile.open("herwig_9pthat11_0924.txt");
    ...
    void analyze(const Event &event)
    {
      ...
      for (unsigned int i = 0; i < jets.size(); i++)
      {
        ...
        mytxtfile << xsecweight << ", " << evid << ", " << missing << ", " << reject << ", " << jets[i].perp() << ", " << jets[i].eta() << ", " << jets[i].phi() << ", " << jets[i].m() << ", " << jets[i].constituents().size() << ", " << parton << ", " << sdjets[i].m() << ", " << sdjets[i].structure_of<fastjet::contrib::SoftDrop>().delta_R() << ", " << sdjets[i].structure_of<fastjet::contrib::SoftDrop>().symmetry() << ", " << -999 << ", " << -999 << ", " << -999 << ", " << -999 << ", " << -999 << ", " << -999 << ", " << -999 << ", " << -999 << ", " << -999 << ", " << i << ", " << -9 << ", " << -9 << ", " << theEvent->event_scale() << ", " << isJP2 << ", " << JP2_et << ", " << JP2_eta << ", " << JP2_phi << "\n";
      }
      for (unsigned int is = 0; is < jets_s.size(); is++)
      {
        if (jets_s[is].user_info<fastjet::MyUserInfo>().matching() == matched)
        ...
        mytxtfile << xsecweight << ", " << evid << ", " << fake << ", -999, -999, -999, -999, -999, -999, -999, -999, -999, -999, " << jets_s[is].perp() << ", " << jets_s[is].eta() << ", " << jets_s[is].phi() << ", " << jets_s[is].m() << ", " << jets_s[is].constituents().size() << ", " << parton_s << ", " << sdjets_s[is].m() << ", " << sdjets_s[is].structure_of<fastjet::contrib::SoftDrop>().delta_R() << ", " << sdjets_s[is].structure_of<fastjet::contrib::SoftDrop>().symmetry() << ", -999, -999, -999, -999, -999, -999"  << ", " << isJP2 << ", " << JP2_et << ", " << JP2_eta << ", " << JP2_phi << "\n";
      }
    }
  ...
  RIVET_DECLARE_PLUGIN(HERWIG_JETS_UNDOTRUTHDECAY);
}